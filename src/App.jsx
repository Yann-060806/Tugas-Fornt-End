...
function App() {
  ...
  return (
    <>
      ...
      <Profile/>
      <h1 style={{textAlign: "center", marginTop: "100px", fontSize: "3rem", color: "#0c77ce"}}> Daftar Dokter Terbaik </h1>
      <div className="card-wraper">
      <Dokter imgDok={"./image/dokbel.png"} nama={"dr Beli Dermawan"} umur={35} spesialis={"Penyakit Dalam"}/>
      <Dokter imgDok={"./image/dokkir.png"} nama={"dr Kira Larasati"} umur={25} spesialis={"Poli Anak"}/>
      <Dokter imgDok={"./image/dokbet.png"} nama={"dr Robert Marisa"} umur={30} spesialis={"Bedah Umum"}/>
      </div>
      <h1 style={{textAlign: "center",  marginTop: "100px", fontSize: "3rem", color: "#0c77ce"}}>&#10084; Layanan & Fasilitas Kami &#10084;</h1>
